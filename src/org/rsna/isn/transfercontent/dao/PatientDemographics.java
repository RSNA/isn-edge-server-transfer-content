...
public class PatientDemographics {
    ...
    public PatientDemographics(int patient_id, String mrn, String patient_name, java.sql.Timestamp dob, String sex, String street, String city, String state, String zip_code) {
