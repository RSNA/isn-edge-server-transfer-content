...
public class DocumentEntrySourceGenerator {
    private static Format formatter;

    public DocumentEntrySourceGenerator() {
    }
        ...
        try {
            ...
            root.setAttribute("xmlns:xdsdemo","htt//mirc.rsna.org/xdsdemo");
...
//            root.appendChild(comment);
            ...
            File outFile = new File(destination + "\\DocumentEntrySource.xml");
